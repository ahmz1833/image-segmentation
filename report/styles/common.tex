...
% footnotehyper must be loaded BEFORE xepersian; it lets \footnote
% inside table/figure floats reach the bottom of the page.
...
% -------------------- Fonts --------------------
\settextfont[Scale=1.166666666666666]{XB Niloofar}
...
\providecommand{\برچسب}{\label}

\newcommand{\REM}[1]{}
\providecommand{\حذف}{\REM}
\newcommand{\لر}{\lr}
